...
<html lang="en">
    <head>
        <title>Excel Correos | <?php echo NAME_SMILEDU;?></title>
        <meta charset="utf-8">
	...
	<body>
                    ...
                    <div class="mdl-content-cards">
                        ...
                        <div class="mdl-card" style="display: none">
                            <div class="mdl-card__title ">
                                <h2 class="mdl-card__title-text" id="titleTb">Correos</h2>
                            </div>
                        	
						    <div class="mdl-card__supporting-text p-0 br-b">
                                <div id="contTablaCorreos"></div>
						    </div>
    			        </div>
                    </div>
                </section>  
                            ...
                            <div class="row">
                                <div class="col-sm-12 mdl-input-group mdl-input-group__only">
                                    <div class="mdl-select">
                                        <select id="cmbSede" name="cmbSede" data-live-search="true" title="Sede" class="form-control pickerButn" onchange="getNivelGradosBySede();">
                                ...
                                <div class="col-sm-12 mdl-input-group mdl-input-group__only">
                                    <div class="mdl-select">
                                        <select id="cmbGradoNivel" name="cmbGradoNivel" data-live-search="true" title="Grado Nivel" class="form-control pickerButn" onchange="getAulasByGradoNivel();">
                                            <option value="">Selec. Nivel Grado</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-sm-12 mdl-input-group mdl-input-group__only">
                                    <div class="mdl-select">
                                        <select id="cmbAula" name="cmbAula" data-live-search="true" title="Aula" class="form-control pickerButn" onchange="getCorreosByAula();">
        ...
        <form action="c_excel_correos/generarExcel" method="post" id="formExcel"></form>
        ...
        <script src="<?php echo RUTA_JS?>jsmantenimiento/jsexcelcorreos.js" charset="UTF-8"></script>
