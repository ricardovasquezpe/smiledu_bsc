                                ...
                                <div class="row-fluid">
                                    <div class="col-sm-6 col-md-4 mdl-input-group">
                                        ...
                                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                            <input class="mdl-textfield__input" type="text" id="apPaternoPostulante" name="apPaternoPostulante" pattern="[A-Z,a-z,Ññ, ,áéíóú,àèìòù,ÀÈÌÒÙ,ÁÉÍÓÚ]*" maxlength="60" <?php echo $disabled?> value="<?php echo (isset($apePaterno) ? $apePaterno: null)?>"
                                    ...
                                    <div class="col-sm-6 col-md-4 mdl-input-group">
                                        ...
                                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                            <input class="mdl-textfield__input" type="text" id="apMaternoPostulante" name="apMaternoPostulante" pattern="[A-Z,a-z,Ññ, ,áéíóú,àèìòù,ÀÈÌÒÙ,ÁÉÍÓÚ]*" maxlength="60" <?php echo $disabled?> value="<?php echo (isset($apeMaterno) ? $apeMaterno: null)?>"
                                    ...
                                    <div class="col-sm-6 col-md-4 mdl-input-group">
                                        <div class="mdl-icon"></div>
                                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                            <input class="mdl-textfield__input" type="text" id="nombresPostulante" name="nombresPostulante" pattern="[A-Z,a-z,Ññ, ,áéíóú,àèìòù,ÀÈÌÒÙ,ÁÉÍÓÚ]*" maxlength="60" <?php echo $disabled?> value="<?php echo (isset($nombres) ? $nombres: null)?>"
					    ...
					    <div class="mdl-card__supporting-text">    				
					       <div class="row-fluid">					       
					           ...
					           <div class="col-sm-6 col-md-4 mdl-input-group">
					                <div class="mdl-icon"></div>
    				                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                        <input class="mdl-textfield__input" type="text" id="apPaternoContactoDetalle" pattern="[A-Z,a-z,Ññ, ,áéíóú,àèìòù,ÀÈÌÒÙ,ÁÉÍÓÚ]*" name="apPaternoContactoDetalle" maxlength="100">        
				               ...
				               <div class="col-sm-6 col-md-4 mdl-input-group">
					                <div class="mdl-icon"></div>
    				                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                        <input class="mdl-textfield__input" type="text" id="apMaternoContactoDetalle" pattern="[A-Z,a-z,Ññ, ,áéíóú,àèìòù,ÀÈÌÒÙ,ÁÉÍÓÚ]*" name="apMaternoContactoDetalle" maxlength="100">        
				               ...
				               <div class="col-sm-6 col-md-4 mdl-input-group">
					                <div class="mdl-icon"></div>
    				                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                        <input class="mdl-textfield__input" type="text" id="nombreContactoDetalle" pattern="[A-Z,a-z,Ññ, ,áéíóú,àèìòù,ÀÈÌÒÙ,ÁÉÍÓÚ]*" name="nombreContactoDetalle" maxlength="100">        
				               ...
				               <div class="col-sm-6 col-md-4 mdl-input-group">
    				                ...
    				                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                        <input class="mdl-textfield__input" type="text" id="correoContactoDetalle" pattern="[Ññ,A-Za-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" name="correoContactoDetalle" maxlength="100">        
