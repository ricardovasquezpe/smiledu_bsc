...
<html lang="en">
    ...
    <body>
							    ...
							    <div class="col-sm-12 mdl-input-group mdl-input-group__only">
                                    <div class="mdl-select">
    							        <select id="selectPreguntaGrafico4"
    										...
    										class="form-control pickerButn" multiple data-actions-box="true"
    										onchange="getGraficoEncuestaPregunta4()" 
    										data-none-selected-text="Seleccione una pregunta">
    										<option>Seleccione Pregunta</option>
    									</select>
									</div>
    	...
    	<script src="<?php echo RUTA_PUBLIC_SENC?>js/jsgraficos/jsgrafico.js"></script>
    	<script src="<?php echo RUTA_PUBLIC_SENC?>js/jsgraficos/jsgrafico_comparar_preg.js"></script>
    	<script src="<?php echo RUTA_PUBLIC_SENC?>js/jsgraficos/jsgrafico_encuesta.js"></script>
    	<script src="<?php echo RUTA_PUBLIC_SENC?>js/jsgraficos/jsgrafico_propuesta_mejora.js"></script>
    	<script src="<?php echo RUTA_PUBLIC_SENC?>js/jsgraficos/jsgrafico_preguntas.js"></script>
