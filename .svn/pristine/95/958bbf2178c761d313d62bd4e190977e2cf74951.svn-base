        ...
        <div class="modal fade" id="modalMigrarMatricula" tabindex="-1" role="dialog" aria-labelledby="simpleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-md">
                <div class="modal-content">                
                    <div class="mdl-card" >
                        <div class="mdl-card__title">
    						<h2 class="mdl-card__title-text">¿Estas seguro de pasarlo al proceso de matrícula?</h2>
    					</div>
					    <div class="mdl-card__supporting-text">
			               <div class="row p-0 m-0" id="msjPassProceso" style="display: none">
                                Recuerda que al pasarlo al proceso de matrícula, todos los datos del estudiante y de sus familiares se enviarán al SISTEMA DE MATRÍCULA.
                                Se enviará las credenciales del sistema de matrícula al correo electrónico del familiar registrado.
			               </div>
