...
<html lang="en">
	...
	<!--                                 </div> -->
	                                ...
	                                <div class="col-sm-4 mdl-input-group">
	                                    ...
	                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
	                                        <input class="mdl-textfield__input datoFam" type="text" id="apellidoPaternoPariente" pattern="[A-Z,a-z,Ññ, ,áéíóú,àèìòù,ÀÈÌÒÙ,ÁÉÍÓÚ]*"  name="apellidoPaternoPariente" maxlength="100" onchange="editarPariente(); camposFam()" attr-obli= "12">        
	                                ...
	                                <div class="col-sm-4 mdl-input-group">
	                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
	                                        <input class="mdl-textfield__input datoFam" type="text" id="apellidoMaternoPariente" pattern="[A-Z,a-z,Ññ, ,áéíóú,àèìòù,ÀÈÌÒÙ,ÁÉÍÓÚ]*" name="apellidoMaternoPariente" maxlength="100" onchange="editarPariente(); camposFam()" attr-obli= "1">        
	                                ...
	                                <div class="col-sm-4 mdl-input-group">
	                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
	                                        <input class="mdl-textfield__input datoFam" type="text" id="nombrePariente" pattern="[A-Z,a-z,Ññ, ,áéíóú,àèìòù,ÀÈÌÒÙ,ÁÉÍÓÚ]*" name="nombrePariente" maxlength="100" onchange="editarPariente(); camposFam()" attr-obli= "12">        
	                                ...
	                                <div class="col-sm-4 mdl-input-group">
	                                    ...
	                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
	                                        <input class="mdl-textfield__input" type="text" id="correoPariente" pattern="[Ññ,A-Za-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" name="correoPariente" maxlength="30" onchange="editarPariente(); camposFam()" attr-obli= "0">        
	...
	<!--                                 </div> -->
	                                ...
	                                <div class="col-sm-4 mdl-input-group">
	                                    ...
	                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
	                                        <input class="mdl-textfield__input datoEst" type="text" id="apellidoPaternoPostulante" pattern="[A-Z,a-z,Ññ, ,áéíóú,àèìòù,ÀÈÌÒÙ,ÁÉÍÓÚ]*" name="apellidoPaternoPostulante" maxlength="100" onchange="editarPostulante();camposPos()" attr-obli= "12">        
	                                ...
	                                <div class="col-sm-4 mdl-input-group">
	                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
	                                        <input class="mdl-textfield__input datoEst" type="text" id="apellidoMaternoPostulante" pattern="[A-Z,a-z,Ññ, ,áéíóú,àèìòù,ÀÈÌÒÙ,ÁÉÍÓÚ]*" name="apellidoMaternoPostulante" maxlength="100" onchange="editarPostulante();camposPos()" attr-obli= "1">        
	                                ...
	                                <div class="col-sm-4 mdl-input-group">
	                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
	                                        <input class="mdl-textfield__input datoEst" type="text" id="nombrePostulante" name="nombrePostulante" pattern="[A-Z,a-z,Ññ, ,áéíóú,àèìòù,ÀÈÌÒÙ,ÁÉÍÓÚ]*" maxlength="100" onchange="editarPostulante();camposPos()" attr-obli= "12">        
