...
<html lang="en">
    <head>
        <title>Certificaci&oacute;n Ingl&eacute;s Alumnos | <?php echo NAME_SMILEDU;?></title>
        <meta charset="utf-8">
	...
	<body>
                    ...
                    <div class="mdl-content-cards">
                        ...
                        <div class="mdl-card" style="display: none">
                            <div class="mdl-card__title">
    							<h2 class="mdl-card__title-text" id="titleTb">Certificaci&oacute;n Ingl&eacute;s Alumnos</h2>
    						</div>       							
    						<div class="mdl-card__supporting-text p-0 br-b">
                                <div id="contTabAlumnos">
                                    <?php echo $tabAlumnos;?>
                                </div>
    						</div>
        			    </div>
                    ...
                    <div class="mdl-card mdl-card-fab">
                          ...
                          <div class="mdl-card__supporting-text">
                              <div class="row">
                                  ...
                                  <div class="col-sm-12 mdl-input-group mdl-input-group__only">
                                      <div class="mdl-select">
                                          <select id="selectGrado" name="selectGrados" data-live-search="true" title="Grado" class="form-control pickerButn">
                          ...
                          <div class="mdl-card__actions">
                            ...
                            <button id="btnCIA" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised" data-dismiss="modal">Aceptar</button>
                          </div>
                    </div>     
                </div>
           </div>
        ...
        <div class="modal fade backModal" id="modalNuevaCompetencia" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                ...
                <div class="modal-content ">
                    <div class="mdl-card">
                        <div class="mdl-card__title mdl-color--indigo p-20">
                            <h2 class="mdl-card__title-text mdl-typography--headline mdl-color-text--white" id="myModalLabelTitle">Registrar Nueva Competencia</h2>
                        </div>
                    </div>    
                </div>     
            </div>
          ...
          <!-- INICIO MODAL ELIMINAR COMPETENCIA -->
                ...
                <div class="modal-content b-o">
                    <div class="mdl-card">
                       ...
                       <div class="mdl-card__supporting-text p-20">
                           <p style="text-align: center" class="textoColor">&#191;Desea Eliminar la <strong>Competencia </strong> Seleccionada?</p>
                       </div>
                       <div class="mdl-card__actions">
                            <a class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised" type="button" id="btn-delete-comp" onclick="confirmDelete(this)">Si</a>
                            <a class="mdl-button mdl-js-button mdl-js-ripple-effect " type="button" data-dismiss="modal">No</a>
						</div>
                    </div>
                </div>
            </div>
        ...
        <script src="<?php echo RUTA_JS?>jsmantenimiento/jscerti_ingles_alumno.js"></script>
   		
		<script type="text/javascript"> 
		init();       	
		initcerti_ingles_alumno();
		$(function() {
            $( "#sortable" ).sortable();
