                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 mdl-input-group mdl-input-group__only">
                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                        <input class="mdl-textfield__input" type="text" id="year" value="<?php echo date('Y'); ?>" maxlength="4"  name="year" readonly="readonly">        
                                        <label class="mdl-textfield__label" for="sample3">A&ntilde;o</label>                            
                                    </div>
                                </div>
                                <div class="col-sm-12 mdl-input-group mdl-input-group__only">
                                    <div class="mdl-select">
                                ...
                                <div class="col-sm-12 mdl-input-group mdl-input-group__only">
                                    <div class="mdl-select">
                                        <select id="selectAula" name="selectAula" data-live-search="true" title="Aula" class="form-control pickerButn">
