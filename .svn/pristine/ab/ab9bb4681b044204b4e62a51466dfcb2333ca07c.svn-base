...
<html lang="en">
    <head>
        ...
        <title>Certificaci&oacute;n Ingl&eacute;s Docentes | <?php echo NAME_SMILEDU;?></title>
        <meta charset="utf-8">
	...
	<body onload="screenLoader(timeInit);">
                    ...
                    <div class="mdl-content-cards">
                        <div class="mdl-card">
                            <div class="mdl-card__title">
        						<h2 class="mdl-card__title-text" id="titleTb">Certificaci&oacute;n Ingl&eacute;s Docentes</h2>
        					</div>               					
        					<div class="mdl-card__supporting-text p-0 br-b">
        					     <div id="contTbDocentes">
        					         <?php echo $tabDocentes;?>
        					      </div>
        					</div>
        			    </div>
                     </div>
        ...
        <script src="<?php echo RUTA_JS?>jsmantenimiento/jscert_ing_doc.js"></script>
