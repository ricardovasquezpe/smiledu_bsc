                    ...
                    <div class="col-sm-12">
		                        ...
		                        <div id="cont_datos_pariente" style="display: <?php echo ($generico == 1)?'none':'block'?>">
                                    ...
                                    <div class="col-sm-4 mdl-input-group">
                                        ...
                                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                            <input class="mdl-textfield__input" type="text" id="apellidoPaternoPariente" pattern="[A-Z,a-z,Ññ, ,áéíóú,àèìòù,ÀÈÌÒÙ,ÁÉÍÓÚ]*"  name="apellidoPaternoPariente" maxlength="100" onchange="cambioCampoFamiliar(this)" value="<?php echo isset($apePaterno)?$apePaterno:null?>">        
                                    ...
                                    <div class="col-sm-4 mdl-input-group">
                                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                            <input class="mdl-textfield__input" type="text" id="apellidoMaternoPariente" pattern="[A-Z,a-z,Ññ, ,áéíóú,àèìòù,ÀÈÌÒÙ,ÁÉÍÓÚ]*" name="apellidoMaternoPariente" maxlength="100" onchange="cambioCampoFamiliar(this)" value="<?php echo isset($apeMaterno)?$apeMaterno:null?>">        
                                    ...
                                    <div class="col-sm-4 mdl-input-group">
                                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                            <input class="mdl-textfield__input" type="text" id="nombrePariente" pattern="[A-Z,a-z,Ññ, ,áéíóú,àèìòù,ÀÈÌÒÙ,ÁÉÍÓÚ]*" name="nombrePariente" maxlength="100" onchange="cambioCampoFamiliar(this)" value="<?php echo isset($nombres)?$nombres:null?>">        
                                    ...
                                    <div class="col-sm-4 mdl-input-group">
                                        ...
                                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                            <input class="mdl-textfield__input" type="text" id="correoPariente" pattern="[Ññ,A-Za-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" name="correoPariente" maxlength="30" onchange="cambioCampoFamiliar(this)" value="<?php echo isset($correo)?$correo:null?>">        
                        ...
                        <div class="mdl-tabs__panel p-rl-10" id="tab2">
                            ...
                            <div class="col-sm-12 text-left cont-agregar p-b-15 m-l-10" id="cont_cabe_hijos" style="margin-top: 20px"></div>
                                ...
                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                        <input class="mdl-textfield__input" type="text" id="apellidoPaternoPostulante" pattern="[A-Z,a-z,Ññ, ,áéíóú,àèìòù,ÀÈÌÒÙ,ÁÉÍÓÚ]*" name="apellidoPaternoPostulante" maxlength="100" onchange="cambioCampoPostulante(this)">        
                                ...
                                <div class="col-sm-4 mdl-input-group">
                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                        <input class="mdl-textfield__input" type="text" id="apellidoMaternoPostulante" pattern="[A-Z,a-z,Ññ, ,áéíóú,àèìòù,ÀÈÌÒÙ,ÁÉÍÓÚ]*" name="apellidoMaternoPostulante" maxlength="100" onchange="cambioCampoPostulante(this)">        
                                ...
                                <div class="col-sm-4 mdl-input-group">
                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                        <input class="mdl-textfield__input" type="text" id="nombrePostulante" name="nombrePostulante" pattern="[A-Z,a-z,Ññ, ,áéíóú,àèìòù,ÀÈÌÒÙ,ÁÉÍÓÚ]*" maxlength="100" onchange="cambioCampoPostulante(this)">        
