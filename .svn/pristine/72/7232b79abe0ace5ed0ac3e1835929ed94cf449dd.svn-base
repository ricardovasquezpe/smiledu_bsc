...
<title>Detalle de curso | <?php echo NAME_MODULO_NOTAS;?></title>
	...
	<body onload="screenLoader(timeInit);">
    					...
    					<div class="mdl-content-cards">
    					   <div class="col-sm-3 col-xs-6 m-0 mdl-input-group mdl-input-group__only">
    					       <div class="mdl-select">
                                    <select id="cmbBimestres" name="cmbBimestres" class="form-control"
                                            data-title="Selec. Competencia" data-btntext-save="Seleccionar" data-btntext-cancel="Cancelar" onchange="getNotasBimestre();">
                                        <option value="">Selec. Bimestre</option>
                                        <?php echo (isset($cmbBimestres)) ? $cmbBimestres : null;?>
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-3 col-xs-6 m-0 mdl-input-group mdl-input-group__only">
                                <div class="mdl-select">
                                    <select id="cmbCursos" name="cmbCursos" class="form-control"
                                            data-title="Selec. Capacidad" data-btntext-save="Seleccionar" data-btntext-cancel="Cancelar" onchange="getNotasBimestre();">
                    ...
                    <div class="col-md-5 col-md-offset-3">
                        <div id="tSolicitudes" class="mdl-card">
                            <div class="mdl-card__title">
                                <h2 class="mdl-card__title-text"><?php echo $nombreAlumno;?></h2>
                            </div>
                            <div class="mdl-card__supporting-text br-b p-0" id="contTbNotas">
                                   <?php echo $tableNotasCursos;?>
                            </div>
        ...
        <ul id="menu" class="mfb-component--br mfb-zoomin display-none" data-mfb-toggle="hover">
            <li class="mfb-component__wrap">
                ...
                <ul class="mfb-component__list">
                    <li>
                        <button class="" data-mfb-label="generar PDF" data-toggle="modal" data-target="#modalAvances">
        ...
        <script src="<?php echo RUTA_PUBLIC_NOTAS?>js/jsDetalleAlumno.js"></script>
